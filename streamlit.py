...
if st.button("Dự đoán rủi ro giao hàng trễ"):
    # Kiểm tra xem tất cả các biến đã được nhập đúng
    if None in [days_for_shipping_real, days_for_shipment_scheduled, benefit_per_order, sales_per_customer,
                order_item_discount, order_item_discount_rate, order_item_product_price, order_item_profit_ratio,
                order_item_quantity, sales]:
        st.write("Vui lòng nhập đầy đủ tất cả thông tin.")
    else:
